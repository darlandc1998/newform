...
public interface AlunoEndPoint {
    ...
    Call<AlunoModel> getAluno(@Query("nome") final String nome, @Query("idUsuario") final Long idUsuario);

    @GET("api/aluno/buscar")
    Call<List<AlunoModel>> getAlunos(@Query("idUsuario") final Long idUsuario);
